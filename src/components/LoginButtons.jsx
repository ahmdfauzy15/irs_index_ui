// src/components/LoginButtons.jsx (modified version)
...
const LoginButtons = () => {
  ...
  const handleLoginClick = (option) => {
    // Open MFA modal first
    setMfaModal({
      isOpen: true,
      userType: option.id,
      userEmail: option.email,
      redirectLink: option.link
    });
  };

  const handleMfaSuccess = () => {
    // Close modal and redirect
    setMfaModal({ isOpen: false, userType: null, userEmail: null, redirectLink: null });
    
    // Redirect to the intended page after successful MFA
    if (mfaModal.redirectLink) {
      window.open(mfaModal.redirectLink, '_blank');
    }
  };
          ...
          >
            ...
            `}>
              ...
              <div className="p-8">
                ...
                {/* Button - Modified to trigger MFA */}
